...
--
-- Host: 127.0.0.1    Database: bugsdb
-- ------------------------------------------------------
...
INSERT INTO `tester` VALUES (1,'Miguel','Bautista','US','2013-08-05 03:57:38'),(2,'Michael','Lubavin','US','2013-07-12 17:27:18'),(3,'Leonard','Sutton','GB','2013-07-17 01:17:28'),(4,'Taybin','Rutkin','US','2013-01-01 15:57:38'),(5,'Mingquan','Zheng','JP','2013-08-05 02:07:38'),(6,'Stanley','Chen','GB','2013-08-05 01:57:38'),(7,'Lucas','Lowry','JP','2013-07-13 03:57:38'),(8,'Sean','Wellington','JP','2013-08-05 17:27:38'),(9,'Darshini','Thiagarajan','GB','2013-08-05 19:00:38');
/*!40000 ALTER TABLE `tester` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tester_device`
--
...
--
-- Dumping data for table `tester_device`
--

LOCK TABLES `tester_device` WRITE;
/*!40000 ALTER TABLE `tester_device` DISABLE KEYS */;
INSERT INTO `tester_device` VALUES (1,1),(1,2),(1,3),(1,10),(2,4),(2,5),(2,6),(2,7),(2,8),(2,9),(3,3),(3,4),(3,5),(3,6),(4,1),(4,2),(5,5),(5,6),(5,7),(5,1),(5,10),(6,3),(7,4),(7,5),(7,6),(7,7),(7,8),(8,1),(8,3),(8,6),(8,9),(8,10),(9,5),(9,6),(9,8),(9,9);
/*!40000 ALTER TABLE `tester_device` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'bugsdb'
--

--
-- Dumping routines for database 'bugsdb'
--
...
-- Dump completed on 2021-04-09  0:02:52
